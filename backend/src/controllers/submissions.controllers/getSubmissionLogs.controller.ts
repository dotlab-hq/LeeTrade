...
export const getSubmissionLogsRoute = createRoute( {
  method: "get",
  path: "/{id}/logs",
  tags: ["Submissions"],
...
export const getSubmissionLogsHandler: RouteHandler<typeof getSubmissionLogsRoute, AppEnv> = async ( c ) => {
