---
name: dockerode
description: dockerode is a Docker Remote API module for Node.js. Use when working with Docker containers, images, and other Docker resources. Triggers on Docker API usage questions.
---
