      ...
      <div className="bg-surface border border-hairline rounded-lg p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="px-4 py-2 bg-surface-elevated border border-hairline rounded-md text-on-dark">
              {user?.role}
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              label: 'Email when submission completes',
              description: 'Get notified when your benchmark run finishes',
            },
            {
              key: 'emailOnFailure',
              label: 'Email on submission failure',
              description: 'Get notified if your submission fails',
            },
            {
              key: 'emailOnRank',
              label: 'Email on rank changes',
              description: 'Get notified when your leaderboard rank changes',
            },
            {
              key: 'emailOnNewChallenge',
              label: 'Email on new challenges',
